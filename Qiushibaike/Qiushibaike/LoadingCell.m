...
@property (nonatomic, retain) UIActivityIndicatorView *indicator;//风火轮， 加载
@property (nonatomic, retain) UILabel *loadingLabel;//正在载入中
...
- (UILabel *)loadingLabel {
    if (!_loadingLabel) {
        self.loadingLabel = [[UILabel alloc] initWithFrame:CGRectMake(0, 0, [UIScreen mainScreen].bounds.size.width, 40)];
        _loadingLabel.textAlignment = NSTextAlignmentCenter;
        _loadingLabel.font = [UIFont systemFontOfSize:15];
        _loadingLabel.text = @"正在输入";
